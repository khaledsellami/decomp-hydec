...
from . import hydec_pb2 as hydec_dot_v2_dot_hydec__pb2
...
class HyDecStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getDecomposition = channel.unary_unary(
                ...
                request_serializer=hydec_dot_v2_dot_hydec__pb2.DecompRequest.SerializeToString,
                response_deserializer=hydec_dot_v2_dot_hydec__pb2.Decomposition.FromString,
                )
        self.getLayers = channel.unary_unary(
                '/hydec.HyDec/getLayers',
                request_serializer=hydec_dot_v2_dot_hydec__pb2.DecompRequest.SerializeToString,
                response_deserializer=hydec_dot_v2_dot_hydec__pb2.DecompositionLayers.FromString,
                )
        self.getDecompositionWithFile = channel.stream_unary(
                '/hydec.HyDec/getDecompositionWithFile',
                request_serializer=hydec_dot_v2_dot_hydec__pb2.DecompFileRequest.SerializeToString,
                response_deserializer=hydec_dot_v2_dot_hydec__pb2.Decomposition.FromString,
                )
...
def add_HyDecServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getDecomposition': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=hydec_dot_v2_dot_hydec__pb2.DecompRequest.FromString,
                    response_serializer=hydec_dot_v2_dot_hydec__pb2.Decomposition.SerializeToString,
            ),
            'getLayers': grpc.unary_unary_rpc_method_handler(
                    servicer.getLayers,
                    request_deserializer=hydec_dot_v2_dot_hydec__pb2.DecompRequest.FromString,
                    response_serializer=hydec_dot_v2_dot_hydec__pb2.DecompositionLayers.SerializeToString,
            ),
            'getDecompositionWithFile': grpc.stream_unary_rpc_method_handler(
                    servicer.getDecompositionWithFile,
                    request_deserializer=hydec_dot_v2_dot_hydec__pb2.DecompFileRequest.FromString,
                    response_serializer=hydec_dot_v2_dot_hydec__pb2.Decomposition.SerializeToString,
            ),
...
class HyDec(object):
    ...
    def getDecomposition(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/hydec.HyDec/getDecomposition',
            hydec_dot_v2_dot_hydec__pb2.DecompRequest.SerializeToString,
            hydec_dot_v2_dot_hydec__pb2.Decomposition.FromString,
    ...
    def getLayers(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/hydec.HyDec/getLayers',
            hydec_dot_v2_dot_hydec__pb2.DecompRequest.SerializeToString,
            hydec_dot_v2_dot_hydec__pb2.DecompositionLayers.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getDecompositionWithFile(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/hydec.HyDec/getDecompositionWithFile',
            hydec_dot_v2_dot_hydec__pb2.DecompFileRequest.SerializeToString,
            hydec_dot_v2_dot_hydec__pb2.Decomposition.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
